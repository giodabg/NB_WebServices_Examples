...
// examples: http://www.java2s.com/example/java-api/java/net/urlconnection/setdooutput-1-29.html
...
class WSConsumer {
    ...
    public int post(String host) {
        ...
        try {
            ...
            String url;
            url = prefix; // i parametri non vengono aggiunti all'url, ma vengono inviati tramite stream
            serverURL = new URL(url);
